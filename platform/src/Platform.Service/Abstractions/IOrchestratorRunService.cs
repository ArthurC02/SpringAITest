...
{
    Task<AgentProxyResponse> StartAsync(Guid orchestratorId, string? message, string? conversationId, JsonElement? initialContext, string? key, UserContext context, CancellationToken ct = default);
