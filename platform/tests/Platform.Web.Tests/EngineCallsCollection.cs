...
/// <summary>
/// 讓 ChatApiTests、CopilotAguiApiTests、SkillApiTests 與 AgentApiTests
/// 序列化(同一 collection 不並行)。
/// 聊天 → Skill 路由後,已登入聊天每輪會呼叫 GetSkillCatalogAsync,累加靜態的
/// FakeWorkflowEngineClient.EngineCalls;而 SkillApiTests 以「請求前後 EngineCalls 不變」
