...
- **Env:** `LLM_BASE_URL` (default `http://localhost:4000`), `CHAT_MODEL` (default `gpt-4o-mini`; `mock-gpt` for keyless testing), `WORKFLOW_BASE_URL`, `BACKEND_BASE_URL`, `RABBITMQ_URL`, `INTERNAL_API_TOKEN`, `JWT_SECRET`.
