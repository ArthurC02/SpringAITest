...
| D6 聊天/AG-UI 整合(canary) — **已交付並完成七輪 review(2026-07-25)** | allowlist 租戶的 authenticated Chat/AG-UI 共用 durable pinned Root Orchestrator；匿名、未 allowlist、disabled 或 Backend `legacy` resolution 保持既有 shared-core，explicit unavailable selection fail-closed。Platform best-effort kick 後由 durable command recovery；回切先關 Platform flag/移除 tenant，再關 Workflow/Backend flags，audit records 保留 | P5 全部；Spike 2、3 契約已落地 | `AGENT_CHAT_ENABLED`（三服務預設 false）+ Platform `AGENT_CHAT_TENANT_ALLOWLIST` | A-CHAT-01~13；Backend 479/479、Platform Service 335/335/Web 269/269、Workflow 862 passed/2 skipped、Frontend 50/50 + build/lint；D6 deterministic verifier 13 PASS；RealModel `20260725T111722672Z-90c9119f` E-04/E-05 PASS；independent review `FINDINGS: 0` | L(高風險) |
