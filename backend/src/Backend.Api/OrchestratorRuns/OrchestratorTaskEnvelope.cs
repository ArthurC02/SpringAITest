...
internal static class OrchestratorTaskEnvelope
{
    ...
    {
        if (raw is not { ValueKind: JsonValueKind.Object } value || JsonUtf8.ByteCount(value) > 65_536) throw new ArgumentException("task_envelope is required and too large");
