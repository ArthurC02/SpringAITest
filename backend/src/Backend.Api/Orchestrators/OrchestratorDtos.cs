...
public sealed record OrchestratorWriteResult(OrchestratorWriteStatus Status, Orchestrator? Orchestrator = null, int Revision = 0, long? CurrentDraftVersion = null);
